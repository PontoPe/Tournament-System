...
public class Main {
    ...
    private static List<String> generateNames() {
        ...
        Collections.addAll(names,
            ...
            "Karina", "Larissa", "Mariana", "Natália", "Olivia", "Patrícia", "Quésia", "Sabrina", "Tatiana",
            ...
            "Carlos", "Pedro", "João", "Lucas", "Mateus", "Gabriel", "Rafael", "Gustavo", "Felipe", "Bruno",
            "Thiago", "Rodrigo", "Eduardo", "Henrique", "Leonardo", "Daniel", "Marcelo", "Ricardo", "André", "Fernando",
            "Diego", "Alexandre", "Renato", "Sérgio", "Paulo", "Roberto", "Vitor", "Murilo", "Vinícius", "Fábio",
            "Igor", "Rogério", "Caio", "Leandro", "Antônio", "Francisco", "Augusto", "Otávio", "Maurício", "Jorge",
            "César", "Mário", "Luiz", "Adriano", "Cláudio", "Marcos", "Ronaldo", "Sandro", "Wilson", "Gilberto",
            "Davi", "Miguel", "Arthur", "Bernardo", "Heitor", "Enzo", "Lorenzo", "Guilherme", "Samuel", "Benjamin",
            "Joaquim", "Henrique", "Lucas", "Matheus", "Isaac", "Vinicius", "Theo", "Luan", "Lucca", "Pedro",
            "José", "Francisco", "Antônio", "Carlos", "Paulo", "Lucas", "Gabriel", "Rafael", "Daniel", "Felipe"
        );
        return names;
    }
